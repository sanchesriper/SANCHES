...
def main(page: ft.Page):
    ...
    # Создаем текстовые поля для ввода x, y и t
    ...
    def calculate():
        try:
            ...
            P = np.sin(x)**3 + log_term / denominator + np.sqrt(x)
    ...
    page.add(x_input, y_input, t_input, calculate_button, result_text)
